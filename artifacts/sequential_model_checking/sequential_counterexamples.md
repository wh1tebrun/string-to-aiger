...
| SQMC002 | negative check: sequential correct AIGER compared with output-forced-false corrupted AIGER | (bc)* | 3 | correct_vs_corrupted_output_forced_false | SAT | SAT | PASS | 'bc' | step 0: char='b', end=0, is_b=1, is_c=0 / step 1: char='c', end=0, is_b=0, is_c=1 / step 2: end, end=1, is_b=0, is_c=0 |
