...
class SequentialAigerWriter:
    ...
    def write(self) -> str:
        """Serialize the sequential circuit into ASCII AIGER.

        The returned string deliberately ends with a final newline. External
        AIGER tools such as aigsim are strict about line-based input and may
        reject files whose final comment line is not terminated.
        """
