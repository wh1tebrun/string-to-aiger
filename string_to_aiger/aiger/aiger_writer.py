...
class AigerWriter:
    ...
    def write(self) -> str:
        ...
        The returned string deliberately ends with a final newline. Some
        external AIGER tools, including aigsim, are strict about line-based
        input and may reject files whose final comment line is not terminated.
        """
